...
PKGS="void-repo-nonfree rpi4-base rpi4-kernel rpi4-kernel-headers rpi-eeprom bzip2 cryptsetup curl dialog ddrescue gnupg2 git gptfdisk gzip efibootmgr lvm2 makepasswd mdadm mosh nano p7zip rsync wget vim unzip xz zip"
