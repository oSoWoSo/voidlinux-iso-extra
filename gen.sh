...
./mklive.sh -a aarch64 -b rpi4-base -r 'https://mirrors.dotsrc.org/voidlinux/current/aarch64' -r 'https://mirrors.dotsrc.org/voidlinux/current/aarch64/nonfree' -p "$PKGS"
